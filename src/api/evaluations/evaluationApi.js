...
export const getPlanningByExamenId = (classeId) =>
  evaluationService.get(`/planning/classe/${classeId}`);
export const getExamenByPlanning = (id) =>
  evaluationService.get(`/planning/classes/planning/${id}`);
export const getPlanningBySessionId = (sessionId) =>
  evaluationService.get(`/planning/session/${sessionId}`);
...
export const getResultatsParClasse = (classeId) =>
  evaluationService.get(`/resultats/classe/${classeId}`);

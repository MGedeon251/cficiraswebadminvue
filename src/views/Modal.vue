          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="text-center">
                ...
                >
                  Click for demo<i class="mdi mdi-play-circle ms-1"></i>
                </button>
              </div>
              <div
                class="modal fade"
          ...
          <div class="col-lg-6 grid-margin stretch-card">
            <div class="card">
              <div class="card-body">
                ...
                <p class="card-description">
                  Use class <code>.accordion-bordered</code> for bordered accordions
                </p>
                <div class="mt-4">
                  <div class="accordion accordion-bordered" id="accordion-2" role="tablist">
                    <div class="card">
                      ...
                      >
                        <div class="card-body">
                          <p class="mb-0">
                            You can pay for the product you have purchased using credit cards, debit
                            cards, or via online banking. We also provide cash-on-delivery services
                            for most of our products. You can also use your account wallet for
                            payment.
                          </p>
                        </div>
                      </div>
                    ...
                    <div class="card">
                      ...
                      >
                        <div class="card-body">
                          <p>
                            If while signing in to your account you see an error message, you can do
                            the following
                          </p>
                          <ol class="pl-3">
                          ...
                          <br />
                          <i class="mdi mdi-alert-octagon me-2"></i>If the problem persists, you can
                          contact our support.
                        </div>
                      </div>
                    </div>
                    <div class="card">
                      ...
                      >
                        <div class="card-body">
                          <p class="mb-0">
                            If you wish to deactivate your account, you can go to the Settings page
                            of your account. Click on Account Settings and then click on Deactivate.
                ...
                <div class="accordion" id="accordion" role="tablist">
                        ...
                        <div class="row">
                          ...
                          <div class="col-9">
                            <p class="mb-0">
                              ...
                              debit cards, or via online banking. We also on-delivery services.
                            </p>
                          </div>
                        </div>
                      </div>
                  ...
                  <div class="card">
                    ...
                    >
                      <div class="card-body">
                        <p class="mb-0">
                          You can add money to the wallet for any future transaction from your bank
                          account using net-banking, or credit/debit card transaction. The money in
                          the wallet can be used for an easier and faster transaction.
                        </p>
                      </div>
                    </div>
                  </div>

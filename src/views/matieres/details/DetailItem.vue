              ...
              <div class="row">
                ...
                <div class="col-6">
                  <div class="detail-item mb-3">
                    ...
                    <span class="detail-value badge bg-info text-dark">{{ module.data.coefficient }}</span>
                  </div>
                </div>
              </div>
            ...
            <div class="col-md-6 ps-4">
              ...
              <div>
                ...
                <div class="accordion" id="filieresAccordion">
                  <div v-for="(filiere, index) in module.data.filieres_classes" :key="index" class="accordion-item border-0 mb-2">
                    <h6 class="accordion-header">
                      <button class="accordion-button collapsed bg-light rounded-2" type="button" data-bs-toggle="collapse" :data-bs-target="'#collapse' + index">
                        <i class="mdi mdi-bookmark-outline text-primary me-2"></i>
                        {{ filiere.filiere }}
                      </button>
                    </h6>
                    <div :id="'collapse' + index" class="accordion-collapse collapse" data-bs-parent="#filieresAccordion">
                      <div class="accordion-body pt-2">
                        <div class="d-flex flex-wrap gap-2">
                          <span v-for="(classe, i) in filiere.classes" :key="i" class="badge bg-light text-dark border">
                            {{ classe }}
                          </span>
                        </div>
                      </div>

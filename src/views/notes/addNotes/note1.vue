        ...
        <aside :class="['app-sidebar', { collapsed: !sidebarOpen }]">
          <div class="sidebar-header">
            ...
            <button class="sidebar-toggle" @click="toggleSidebar">
              <i :class="sidebarOpen ? 'bi bi-chevron-double-left' : 'bi bi-chevron-double-right'"></i>
            </button>
          </div>
                ...
                <div class="row g-3">
                  ...
                  <div class="col-md-4">
                    ...
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control" placeholder="Ex: Compréhension écrite" />
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="notes-table-container">
                ...
                <table class="table notes-table">
                  ...
                  <tbody>
                    <tr v-for="(student, index) in filteredStudents" :key="student.matricule" 
                        :class="{'highlight-row': student.note >= 16, 'warning-row': student.note < 10}">
                      <td>{{ index + 1 }}</td>
              ...
              <div class="table-footer">
                <div class="showing-entries">
                  Affichage de 1 à {{ filteredStudents.length }} sur {{ filteredStudents.length }} entrées
                </div>
              </div>
            </div>
          </div>

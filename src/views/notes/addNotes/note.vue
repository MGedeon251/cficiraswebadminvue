  ...
  <div class="container-fluid g-0">
    ...
    <div class="d-flex">
      ...
      <main class="flex-fill">
        <div
          class="content-header p-3 bg-light border-bottom d-flex justify-content-between align-items-center"
        >
          ...
          >
            ...
            <div>
              <button class="btn btn-primary" @click="saveAllGrades" :disabled="saving">
                ...
                <span v-else> <i class="bi bi-save me-1"></i> Enregistrer toutes les notes </span>
              </button>
            </div>
          </div>
        </div>

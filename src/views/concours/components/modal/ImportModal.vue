<template>
  <a-modal
    ...
    @cancel="close"
  >
    <a-upload-dragger :beforeUpload="handleFile" accept=".xlsx,.xls,.csv" :showUploadList="false">
      <p class="ant-upload-drag-icon">
        <inbox-outlined />
      </p>
      <p class="ant-upload-text">Cliquez ou glissez un fichier pour l'importer</p>

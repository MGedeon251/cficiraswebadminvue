<template>
    <div class="container-fluid">
      ...
      <header class="d-flex justify-content-between align-items-center py-3 border-bottom">
        ...
        <div class="dropdown">
          <button class="btn btn-secondary dropdown-toggle" type="button" id="anneeDropdown" data-bs-toggle="dropdown">
            ...
            <table class="table table-striped table-hover">
              ...
              <tbody>
                <tr v-for="(student, index) in students" :key="student.matricule">
                  ...
                  <td>
                    <input type="number" class="form-control form-control-sm" v-model="student.note" min="0" max="20" step="0.5">
                  </td>

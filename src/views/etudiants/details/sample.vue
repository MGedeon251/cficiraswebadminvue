                  ...
                  <div class="col-lg-8">
                    <div class="info-section personal-info">
                      ...
                      <div class="row g-3">
                        ...
                        <div class="col-md-6">
                          <div class="form-floating">
                            <input type="text" class="form-control" id="lieu-naissance" placeholder="Lieu de naissance">
                  ...
                  <div class="col-lg-4">
                    ...
                    <div class="info-section profile-photo-section mb-4">
                      ...
                      <div class="text-center">
                        <div class="profile-photo-container mb-3">
                          <img v-if="previewImage" :src="previewImage" class="profile-photo" alt="Photo étudiant">
                          <img v-else src="/img/default-profile.png" class="profile-photo" alt="Photo par défaut">
                    ...
                    <div class="info-section academic-info">
                      ...
                      <div class="form-floating mb-3">
                        <input type="text" class="form-control" id="annee-academique" placeholder="Année académique">

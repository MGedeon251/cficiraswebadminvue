  ...
  <div class="container-fluid p-0">
    ...
    <div class="row mb-4 align-items-center">
      <div class="col">
        ...
        <p class="text-muted small mb-0">Répartition des étudiants dans les groupes pédagogiques et projets.</p>
      </div>
      <div class="col-auto">
        ...
        <div class="row g-3">
          ...
          <div class="col-md-4">
            <div class="input-group shadow-sm">
              ...
              <input v-model="searchQuery" type="text" class="form-control border-0" placeholder="Rechercher un étudiant...">
            </div>
          </div>
      ...
      <div class="col-lg-4">
        <div class="card border-0 shadow-sm h-100">
          ...
          <div class="card-body p-0 scrollable-list" style="max-height: 600px; overflow-y: auto;">
            ...
            <div v-else v-for="e in filteredEtudiants" :key="e.id" 
            ...
            <div class="card border-0 shadow-sm h-100">
              <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center border-0">
                <div>
                  ...
                  <small class="text-muted">{{ etudiantsParGroupe(groupe.id).length }} étudiants</small>
                </div>
                <div class="dropdown">
              ...
              <div class="card-body pt-0">
                <div class="bg-light rounded p-2" style="min-height: 150px;">
                  <div v-for="etudiant in etudiantsParGroupe(groupe.id)" 
                       :key="etudiant.id" 
                       class="d-flex align-items-center bg-white p-2 rounded mb-2 shadow-xs border shadow-sm">
                    <small class="flex-grow-1 fs-13 fw-semibold">{{ etudiant.nom }} {{ etudiant.prenom }}</small>
                  ...
                  <div v-if="etudiantsParGroupe(groupe.id).length === 0" 
...
.bg-info-lighten { background-color: rgba(49, 191, 191, 0.15); }
.student-item:hover { background-color: #fcfcfc; }

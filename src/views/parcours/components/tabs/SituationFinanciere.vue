            ...
            <table class="table table-hover align-middle">
              ...
              <tbody>
                <tr v-for="(paiement, index) in paiements" :key="index">
                  ...
                  <td>{{ paiement.date }}</td>
                  <td><small>{{ paiement.libelle }}</small></td>
    ...
    <div class="col-md-5">
      <div class="card border-0 shadow-sm h-100">
        <div class="card-header bg-white py-3">
          <h6 class="m-0 fw-bold"><i class="bi bi-calendar-check me-2"></i>Échéancier de Paiement</h6>
        </div>
        <div class="card-body">
          <div class="list-group list-group-flush">
            <div v-for="(echeance, index) in echeancier" :key="index" class="list-group-item px-0 py-3">
              <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="text-end">
                  <span v-if="echeance.statut === 'Payé'" class="badge rounded-pill bg-success-subtle text-success">Payé</span>
                  <span v-else-if="echeance.statut === 'Partiel'" class="badge rounded-pill bg-warning-subtle text-warning">Partiel</span>
                  <span v-else class="badge rounded-pill bg-danger-subtle text-danger">En attente</span>
          ...
          <div class="mt-3 p-3 bg-light rounded">
            <p class="small text-muted mb-0 italic">
              <i class="bi bi-info-circle me-1"></i> Les frais d'inscription et de bibliothèque sont inclus dans le premier versement.
            </p>
          </div>
        </div>
      </div>
...
const paiements = ref([
  { numero: "REC-7842", date: "05/01/2026", libelle: "Scolarité - Tranche 2", montant: 300000, methode: "Virement" },
  { numero: "REC-6521", date: "12/10/2025", libelle: "Scolarité - Tranche 1", montant: 400000, methode: "Espèces" },
  { numero: "REC-6100", date: "05/09/2025", libelle: "Frais d'inscription", montant: 150000, methode: "Mobile Money" },
]);

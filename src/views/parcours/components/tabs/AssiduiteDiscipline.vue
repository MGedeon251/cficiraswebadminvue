      ...
      <div class="card border-0 shadow-sm mb-4">
        <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center">
          <h6 class="m-0 fw-bold">
            <i class="bi bi-calendar-x me-2"></i>Registre des Absences & Retards
          </h6>
              ...
              <tbody>
                <tr v-for="(item, index) in absences" :key="index">
                  ...
                  <td class="text-end pe-4">
                    ...
                    <span
                      v-else
                      class="small text-muted text-truncate d-inline-block"
      ...
      <div class="card border-0 shadow-sm">
        <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center">
          <h6 class="m-0 fw-bold text-danger">
            <i class="bi bi-shield-exclamation me-2"></i>Mesures Disciplinaires
          </h6>
        ...
        <div class="card-body">
          <div v-if="sanctions.length > 0" class="vertical-timeline">
            <div
              v-for="(sanc, idx) in sanctions"
              :key="idx"
              class="pb-3 border-start ps-3 position-relative ms-2"
            >
              <div
                class="dot position-absolute start-0 translate-middle-x bg-danger rounded-circle"
                style="width: 10px; height: 10px; margin-left: -1px; margin-top: 6px"
              ></div>
      ...
      <div class="card border-0 shadow-sm mt-4">
        <div class="card-body">
          ...
          <textarea
            ...
            rows="3"
            placeholder="Note sur le comportement de l'élève..."
          ></textarea>
...
const sanctions = ref([
  {
    ...
    decision: 'Rencontre avec les parents',
  },
  {
    date: '10/01/2026',
    type: 'Blâme',
    motif: 'Plagiat sur un projet',
    decision: 'Note de 0/20 sur le TP',
  },
]);

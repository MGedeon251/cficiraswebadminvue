                            ...
                            <ul class="nav nav-tabs px-4" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a
                                        ...
                                        role="tab"
                                        aria-controls="sales"
                                        aria-selected="false">Sessions ordinaires</a>
                                </li>
                                <li class="nav-item">
                                    <a
                                        class="nav-link"
                                        ...
                                        aria-selected="false">Sessions de rappels</a>
                                </li>
                            </ul>
                                ...
                                <div
                                    ...
                                    <div class="d-flex flex-wrap justify-content-xl-between">
                                        <div class="card-body">
                                            ...
                                            <h4 class="card-title">Classes et parcours
                                            </h4>

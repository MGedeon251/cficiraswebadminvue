                  ...
                  for (e = 0; e < r; ++e)
                    (n = a.getDatasetMeta(e)).bar &&
                      ...
                      (!1 === o ||
                        ...
                        (void 0 === o && (void 0 === n.stack || -1 === l.indexOf(n.stack)))) &&
                      l.push(n.stack);
                  return l.length;
                },
              ...
              t.controllers.doughnut = t.controllers.pie = t.DatasetController.extend({
                ...
                updateElement: function (t, e, n) {
                  ...
                  this.removeHoverStyle(t),
                    (n && s.animateRotate) ||
                      ((b.startAngle =
                        0 === e ? l.rotation : i.getMeta().data[e - 1]._model.endAngle),
                ...
                updateElement: function (t, e, n) {
                  ...
                  void 0 !== u.radius && void 0 === u.pointRadius && (u.pointRadius = u.radius),
                    ...
                    (t._model = {
                      ...
                      pointStyle:
                        s.pointStyle || o.valueAtIndexOrDefault(u.pointStyle, e, g.pointStyle),
                      ...
                      hitRadius:
                        s.hitRadius || o.valueAtIndexOrDefault(u.pointHitRadius, e, g.hitRadius),
                    });
                },
                ...
                update: function (t) {
                  ...
                  (n.outerRadius = Math.max((s - l.borderWidth / 2) / 2, 0)),
                    (n.innerRadius = Math.max(
                      r.cutoutPercentage ? (n.outerRadius / 100) * r.cutoutPercentage : 1,
                      0
                    )),
                    (n.radiusLength = (n.outerRadius - n.innerRadius) / n.getVisibleDatasetCount()),
              ...
              a.extend(t.prototype, {
                ...
                updateDataset: function (t) {
                  ...
                  !1 !== s.notify(e, 'beforeDatasetUpdate', [i]) &&
                    (n.controller.update(), s.notify(e, 'afterDatasetUpdate', [i]));
                },
                render: function (e) {
                  var n = this;
              ...
              return o.merge(o.clone(arguments[0]), [].slice.call(arguments, 1), {
                merger: function (e, n, i, a) {
                  ...
                  'scales' === e
                    ...
                    : 'scale' === e
                      ? (n[e] = o.merge(r, [t.scaleService.getScaleDefaults(l.type), l]))
                      : o._merger(e, n, i, a);
                },
              });
            }),
                      ...
                      for (n[e] || (n[e] = []), r = 0; r < u; ++r)
                        (s = i[e][r]),
                          ...
                          !n[e][r].type || (s.type && s.type !== n[e][r].type)
                            ? o.merge(n[e][r], [t.scaleService.getScaleDefaults(l), s])
                            : o.merge(n[e][r], s);
          ...
          e.exports = function (t) {
            ...
            t.layoutService = {
              ...
              configure: function (t, e, n) {
                for (
                  var i, a = ['fullWidth', 'position', 'weight'], o = a.length, r = 0;
                  r < o;
                  ++r
                )
                ...
                if (t) {
                  ...
                  i.each(g.concat(p, v, m), function (t) {
                    var e,
                      n = t.isHorizontal();
                    n
                      ? ((e = t.update(t.fullWidth ? x : S, M)), (C -= e.height))
                  ...
                  for (i = 0; i < u; ++i)
                    if (
                      ...
                      'function' == typeof (l = o[e]) &&
                        ((r = [t].concat(n || [])).push(a.options), !1 === l.apply(o, r)))
                    )
                      return !1;
                  return !0;
                },
        ...
        function (t, e, n) {
          ...
          function a(t, e, n) {
            ...
            return (
              n &&
                (i -=
                  0 === e ? (t.getPixelForTick(1) - i) / 2 : (i - t.getPixelForTick(e - 1)) / 2),
              i
            );
          }
          var o = t(25),
                ...
                fit: function () {
                  ...
                  if (u.display && h) {
                    ...
                    if (f) {
                      ...
                      0 !== t.labelRotation
                        ? ((t.paddingLeft = 'bottom' === r.position ? w * S + 3 : w * x + 3),
                          (t.paddingRight = 'bottom' === r.position ? w * x + 3 : w * C + 3))
                ...
                _autoSkip: function (t) {
                  ...
                  for (
                    s.maxTicksLimit && (a = s.maxTicksLimit),
                      r &&
                        ((e = !1),
                        (h + s.autoSkipPadding) * u > o.width - (o.paddingLeft + o.paddingRight) &&
                          (e =
                            1 +
                            Math.floor(
                ...
                draw: function (t) {
                  ...
                  if (i.display) {
                    ...
                    if (
                      ...
                      if (p)
                        (T = e.left + (e.right - e.left) / 2),
                          (F =
                            'bottom' === i.position ? e.bottom - R - S.bottom : e.top + R + S.top);
                      else {
                    ...
                    if (h.drawBorder) {
                      ...
                      p
                        ? ((W = N = 'top' === i.position ? e.bottom : e.top), (W += V), (N += V))
                        : ((z = B = 'left' === i.position ? e.right : e.left), (z += V), (B += V)),
                        r.beginPath(),
                        r.moveTo(z, W),
                        r.lineTo(B, N),
                        r.stroke();
                  ...
                  for (s = 0; s < c; ++s)
                    (d = null),
                      (u = (l = i.getDatasetMeta(s)).dataset) &&
                        u._model &&
                        u instanceof a.Line &&
                        (d = { visible: i.isDatasetVisible(s), fill: t(u, s, c), chart: i, el: u }),
                      (l.$filler = d),
                      f.push(d);
                  for (s = 0; s < c; ++s)
                  ...
                  draw: function () {
                    ...
                    if (n.display) {
                      ...
                      var b = e(a, g),
                        ...
                        w = t.isHorizontal();
                      d = w
                        ? { x: t.left + (s - u[0]) / 2, y: t.top + a.padding, line: 0 }
                      ...
                      o.each(t.legendItems, function (e, n) {
                        ...
                        w
                          ? r + o >= s &&
                            ((l = d.y += M), d.line++, (r = d.x = t.left + (s - u[d.line]) / 2))
                          : l + M > t.bottom &&
            ...
            var e = t.Scale.extend({
              ...
              determineDataLimits: function () {
                ...
                void 0 !== t.options.ticks.min &&
                  ((n = e.indexOf(t.options.ticks.min)), (t.minIndex = -1 !== n ? n : t.minIndex)),
              ...
              getPixelForValue: function (t, e) {
                ...
                if (
                  (void 0 !== t && null !== t && (n = i.isHorizontal() ? t.x : t.y),
                    ...
                    i.each(r, function (a, r) {
                      ...
                      o.isDatasetVisible(r) &&
                        ...
                        i.each(a.data, function (t, i) {
                          ...
                          isNaN(o) ||
                            l.data[i].hidden ||
                            ((a[i] = a[i] || 0), n.relativePoints ? (a[i] = 100) : (a[i] += o));
                        }));
                    }),
                      i.each(d, function (t) {
                        var n = i.min(t),
                              ...
                              (n =
                                l === o.end
                                  ...
                                  : l === o.minNotZero
                                    ...
                                    : o.top +
                                      0.02 * e +
                                      ((0.98 * e) / a) * (i.log10(l) - i.log10(o.minNotZero))))
                            : 0 === l
      ...
      56: [
        function (t, e, n) {
          ...
          e.exports = function (t) {
            ...
            function r(t, e, n) {
              return a.isArray(n)
                ? { w: a.longestText(t, t.font, n), h: n.length * e + 1.5 * (n.length - 1) * e }
              ...
              b = t.LinearScaleBase.extend({
                ...
                getBasePosition: function () {
                  ...
                  return t.getPointPositionForValue(
                    0,
                    t.beginAtZero ? 0 : e < 0 && n < 0 ? n : e > 0 && n > 0 ? e : 0
                  );
                },
                draw: function () {
                  var t = this,
          ...
          function o(t, e, n, i) {
            ...
            for (d.push(n), a = 0, o = d.length; a < o; ++a)
              (s = d[a + 1]),
                (r = d[a - 1]),
                (l = d[a]),
                (void 0 !== r && void 0 !== s && Math.round((s + r) / 2) === l) ||
          ...
          e.exports = function (t) {
            var e = t.Scale.extend({
              ...
              determineDataLimits: function () {
                ...
                v.length &&
                  ((v = a(v).sort(i)), (h = Math.min(h, v[0])), (f = Math.max(f, v[v.length - 1]))),
                  g.length &&
                    ((g = a(g).sort(i)),
                    (h = Math.min(h, g[0])),
